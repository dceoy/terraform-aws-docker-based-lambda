...
inputs = {
  ...
  docker_image_primary_tag                    = get_env("DOCKER_PRIMARY_TAG", run_cmd("git", "rev-parse", "--short", "HEAD"))
  ...
  enable_asynchronous_invocations             = true
  ...
  sqs_redrive_policy_max_receive_count        = 10
